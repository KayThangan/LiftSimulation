...
public class SimulationPanel extends JPanel {
     ...
     */
    public SimulationPanel(int maxBuildingFloor, int liftWeight, int passengerVolume, Boolean isAuto) {
        setLayout(null);
        setPreferredSize(new Dimension(855, 630));

        this.building = new BuildingPanel(0, 0,850, 620, Color.WHITE, maxBuildingFloor, liftWeight, passengerVolume, isAuto);
